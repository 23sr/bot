...
do {
include 'Tools/Proxy.php';
curl_setopt($ch, CURLOPT_URL, 'https://www.homeloft.sg/cart/add.js');
curl_setopt($ch, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'form_type=product&utf8=%E2%9C%93&id=42628819910823&quantity=1');
$curl1 = curl_exec($ch);

...
if (strpos($text, '/add') === 0) { if ($gId != 6094779754 && $gId != 6094779754) { $url = 'https://api.telegram.org/bot'.$bot_token.'/sendMessage';
            $data = http_build_query(array(
                'chat_id' => $chat_id,
                'text' => "Sorry My Owner is <b><a href='tg://user?id=6094779754'>slatt</a></b>",
